...
Steps.defaultProps = {
  step4Title: 'Track Your Campaigns',
  step3Description:
    'Upload your email list in CSV format and customize the sender name, subject, and email message.',
  step2Title: 'Choose Your Plan',
  step1Title: 'Sign Up',
  step1Description:
    'Create an account on our platform to get started with sending emails.',
  step3Title: 'Import Your Email List',
  step4Description:
    'Access your dashboard to monitor the performance of your email campaigns and track their success.',
  step2Description:
    'Select the email sending plan that fits your needs using the pricing slider.',
}
